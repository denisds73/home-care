...
export default function AccountSheet() {
  ...
  return (
    <>
      <div className="fixed inset-0 z-[54] bg-black/40" onClick={close} role="button" aria-label="Close account menu" tabIndex={-1} onKeyDown={e => e.key === 'Escape' && close()} />
        ...
        <div className="px-5 pb-6">
          ...
          <div className="space-y-1">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-left text-primary hover:bg-gray-50 transition min-h-[44px]"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-left text-red-500 hover:bg-red-50 transition min-h-[44px]"
            >
