...
export default function Hero() {
  return (
    <div className="hero-section text-white py-16 sm:py-20 md:py-28" style={{ background: `url(${heroBg}) center/cover no-repeat`, minHeight: '420px', position: 'relative' }}>
      <div className="hero-overlay" style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(11,18,32,.88) 0%, rgba(23,37,84,.72) 48%, rgba(109,40,217,.65) 100%)' }} />
