...
export const CATEGORY_IMAGES = {
  ac: acImg, tv: tvImg, refrigerator: fridgeImg,
  microwave: microwaveImg, water_purifier: purifierImg, washing_machine: acImg
}

export const SERVICE_IMAGES = { ...CATEGORY_IMAGES }

export const STORYSET_IMGS = {
...
export const CATEGORY_SVGS = {
  ...
  tv: `<svg viewBox="0 0 64 64" fill="none"><rect x="6" y="14" width="52" height="32" rx="4" fill="#F5F3FF" stroke="#4C1D95" stroke-width="2"/><rect x="10" y="18" width="44" height="24" rx="2" fill="#DDD6FE"/><rect x="22" y="50" width="20" height="4" rx="2" fill="#4C1D95"/><circle cx="32" cy="30" r="8" fill="#4C1D95" opacity=".3"/><path d="M29 27l8 5-8 5V27z" fill="#4C1D95"/></svg>`,
  refrigerator: `<svg viewBox="0 0 64 64" fill="none"><rect x="14" y="4" width="36" height="56" rx="6" fill="#EDE9FE" stroke="#7C3AED" stroke-width="2"/><line x1="14" y1="28" x2="50" y2="28" stroke="#7C3AED" stroke-width="2"/><rect x="40" y="16" width="3" height="8" rx="1.5" fill="#7C3AED"/><rect x="40" y="34" width="3" height="8" rx="1.5" fill="#7C3AED"/></svg>`,
  microwave: `<svg viewBox="0 0 64 64" fill="none"><rect x="6" y="14" width="52" height="36" rx="6" fill="#FEF3C7" stroke="#D4A017" stroke-width="2"/><rect x="10" y="18" width="32" height="28" rx="4" fill="#FDE68A"/><circle cx="50" cy="24" r="3" fill="#D4A017"/><circle cx="50" cy="32" r="3" fill="#D4A017"/></svg>`,
  water_purifier: `<svg viewBox="0 0 64 64" fill="none"><rect x="14" y="6" width="36" height="48" rx="6" fill="#DCFCE7" stroke="#16A34A" stroke-width="2"/><circle cx="32" cy="24" r="10" fill="#86EFAC" stroke="#16A34A" stroke-width="1.5"/><path d="M32 18v4l3 2" stroke="#16A34A" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  washing_machine: `<svg viewBox="0 0 64 64" fill="none"><rect x="10" y="4" width="44" height="56" rx="6" fill="#F3F4F6" stroke="#6B7280" stroke-width="2"/><circle cx="32" cy="36" r="14" fill="#E5E7EB" stroke="#6B7280" stroke-width="1.5"/><circle cx="32" cy="36" r="8" fill="#9CA3AF" opacity=".4"/><rect x="16" y="10" width="8" height="5" rx="2" fill="#9CA3AF"/><rect x="28" y="10" width="8" height="5" rx="2" fill="#9CA3AF"/><circle cx="44" cy="12" r="3" fill="#6B7280"/></svg>`
}
