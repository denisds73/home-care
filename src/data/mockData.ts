...
export const mockJobs: Job[] = [
  { id: 'j-1', bookingId: 'HC-1001', partnerId: 'p-1', customerName: 'Priya Sharma', phone: '9988776655', address: '42, 1st Cross, Koramangala', category: 'ac', serviceName: 'AC Basic Service', price: 899, preferredDate: '2026-04-05', status: 'new', createdAt: '2026-04-04T08:00:00Z' },
  { id: 'j-2', bookingId: 'HC-1002', partnerId: 'p-1', customerName: 'Rahul Verma', phone: '9988776656', address: '15, 3rd Block, HSR Layout', category: 'refrigerator', serviceName: 'Refrigerator Gas Recharge', price: 749, preferredDate: '2026-04-05', status: 'accepted', createdAt: '2026-04-03T14:00:00Z' },
  { id: 'j-3', bookingId: 'HC-1003', partnerId: 'p-1', customerName: 'Meena Iyer', phone: '9988776657', address: '88, 5th Main, Indiranagar', category: 'ac', serviceName: 'AC Gas Recharge', price: 1499, preferredDate: '2026-04-04', status: 'in_progress', createdAt: '2026-04-02T10:00:00Z' },
  { id: 'j-4', bookingId: 'HC-998', partnerId: 'p-1', customerName: 'Arun Das', phone: '9988776658', address: '22, Church Street', category: 'ac', serviceName: 'AC Installation', price: 1299, preferredDate: '2026-04-01', status: 'completed', createdAt: '2026-03-30T09:00:00Z' },
  { id: 'j-5', bookingId: 'HC-995', partnerId: 'p-1', customerName: 'Sneha Rao', phone: '9988776659', address: '7, Residency Road', category: 'refrigerator', serviceName: 'Refrigerator Repair', price: 649, preferredDate: '2026-03-29', status: 'completed', createdAt: '2026-03-28T11:00:00Z' },
  { id: 'j-6', bookingId: 'HC-1007', partnerId: 'p-1', customerName: 'Vikash Jain', phone: '9988776660', address: '31, BTM 2nd Stage', category: 'ac', serviceName: 'AC Jet Wash', price: 999, preferredDate: '2026-04-06', status: 'new', createdAt: '2026-04-04T12:00:00Z' },
  { id: 'j-7', bookingId: 'HC-990', partnerId: 'p-1', customerName: 'Nisha Gupta', phone: '9988776661', address: '55, Jayanagar 4th Block', category: 'ac', serviceName: 'AC Dismantle', price: 499, preferredDate: '2026-03-25', status: 'declined', createdAt: '2026-03-24T08:00:00Z' },
]
