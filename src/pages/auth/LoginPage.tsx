...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-dvh max-md:h-dvh max-md:max-h-dvh max-md:overflow-hidden overflow-x-hidden bg-surface flex flex-col md:min-h-screen md:h-auto md:max-h-none md:overflow-visible md:flex-row fade-in">
      {/* Brand panel — stacked on mobile, left column on desktop */}
      <div
        className="relative shrink-0 flex flex-col items-center justify-center pt-[max(1.25rem,env(safe-area-inset-top))] pb-6 max-md:ps-[max(1rem,env(safe-area-inset-left))] max-md:pe-[max(1rem,env(safe-area-inset-right))] md:px-4 md:pt-14 md:pb-14 md:w-[45%] lg:w-[50%] md:min-h-screen md:sticky md:top-0"
        style={{
          background:
            'linear-gradient(140deg, #0B1220 0%, #4C1D95 52%, #6D28D9 120%)',
        }}
      >
        <div className="flex items-center mb-3 text-white">
          <Logo adaptive className="h-11 w-auto" />
        </div>
        ...
        <div className="hidden md:flex flex-col gap-4 mt-8 max-w-xs">
          {[
            ...
            {
              text: '30-day service guarantee on all bookings',
              icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z',
            },
            {
              text: 'Trusted by 50,000+ homeowners across India',
      ...
      <div
        ref={formPanelRef}
        className={`flex-1 min-h-0 flex flex-col max-md:items-stretch md:items-center max-md:overflow-y-auto max-md:overscroll-y-contain md:justify-center max-md:py-4 max-md:ps-[max(1rem,env(safe-area-inset-left))] max-md:pe-[max(1rem,env(safe-area-inset-right))] md:px-8 lg:px-16 pb-[max(1rem,env(safe-area-inset-bottom))] md:pb-0 md:py-0 md:overflow-visible ${tab === 'signup' ? 'max-md:justify-start' : 'max-md:justify-center'}`}
      >
        <div
          className={`w-full max-w-[420px] max-md:relative max-md:z-10 ${tab === 'login' ? 'max-md:-translate-y-6' : ''}`}
        >
          ...
          <div className="glass-card no-hover w-full overflow-hidden max-md:rounded-2xl max-md:shadow-[0_-6px_28px_rgba(0,0,0,0.14)] md:rounded-2xl md:shadow-[0_4px_24px_rgba(0,0,0,0.06)] md:border md:border-border-default">
            {/* Tabs */}
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      ...
                      {phoneVerified && (
                        <span
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-success fade-in"
